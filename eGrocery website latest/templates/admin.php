        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="admin_newproduct.php" method="POST" id="newProductForm">
                <div class="form-group">
                  <label for="product-name" class="col-form-label">Product Name:</label>
                  <input type="text" class="form-control" name="name" id="product-name" required>
                </div>
                <div class="form-group">
                  <label for="quantity-text" class="col-form-label">Availability</label>
                  <input type="text" class="form-control" value="In stock" name="avail" id="quantity-text" required></input>
                </div>
                <div class="form-group">
                  <label for="category-select">Category</label>
                  <input type="text" class="form-control" name="category" id="category-select" required></input>
                  <!-- <select form="newProductForm" name="category-select" id="category-select" name="category" class="form-select form-select-lg">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="price" id="price-text"></input>
                </div>
                <div class="form-group">
                  <label for="image-url" class="col-form-label">Image URL</label>
                  <input type="text" class="form-control" name="url" id="image-url"></input>
                </div>
                <button type="button" class="btn btn-secondary " data-dismiss="modal">Close</button>
                <button type="submit" id="saveToCatalog-button" class="btn btn-primary">Save to Catalog</button>
